...
from .views import about_view, dashboard_view, google_login_callback_view, google_login_start_view, home_view, login_view, logout_view, packages_view, register_view, shark_key_view, shark_tutorial_view, shark_cnn_view, shark_cnn_load_model_view
...
urlpatterns = [
    ...
    path("shark-cnn/tutorial/", shark_tutorial_view, name="shark_tutorial"),
